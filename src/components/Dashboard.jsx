                ...
                <>
                    ...
                    <div className="kpi-grid">
                        ...
                        <div className="kpi-card success">
                            ...
                            <div className="kpi-value">{formatNumber(stats.approvedEnquiries)}</div>
                            <div className="kpi-trend positive">
                                <FiTrendingUp />
                                <span>Success rate: {calculatePercentage(stats.approvedEnquiries, stats.totalEnquiries)}%</span>
                            </div>
                        </div>
                        ...
                        <div className="status-analytics">
                            ...
                            <div className="status-card">
                                <div className="status-info">
                                    ...
                                    <div className="status-value">{formatNumber(stats.approvedEnquiries)}</div>
                                </div>
                                <div className="progress-bar">
                                    <div
                                        className="progress-fill approved"
                                        style={{ width: `${calculatePercentage(stats.approvedEnquiries, stats.totalEnquiries)}%` }}
                                    >
                                        <span className="progress-label">
                                            {calculatePercentage(stats.approvedEnquiries, stats.totalEnquiries)}%
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="status-card">
                                <div className="status-info">
                                    ...
                                    <div className="status-value">{formatNumber(stats.rejectedEnquiries)}</div>
                                </div>
                                <div className="progress-bar">
                                    <div
                                        className="progress-fill disbursed"
                                        style={{ width: `${calculatePercentage(stats.rejectedEnquiries, stats.totalEnquiries)}%` }}
                                    >
                                        <span className="progress-label">
                                            {calculatePercentage(stats.rejectedEnquiries, stats.totalEnquiries)}%
                                        </span>
                                    </div>
                                </div>
                            </div>
